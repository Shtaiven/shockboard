...
.extrude({ offset: [0, 0, 5.6] });
                ...
                let _wall_low__part_0 = _outer_wall_low_case_fn();
                ...
                // creating part 1 of case _wall_low
                let _wall_low__part_1 = _inner_wall_low_case_fn();

                // make sure that rotations are relative
                let _wall_low__part_1_bounds = _wall_low__part_1.getBounds();
                let _wall_low__part_1_x = _wall_low__part_1_bounds[0].x + (_wall_low__part_1_bounds[1].x - _wall_low__part_1_bounds[0].x) / 2
                let _wall_low__part_1_y = _wall_low__part_1_bounds[0].y + (_wall_low__part_1_bounds[1].y - _wall_low__part_1_bounds[0].y) / 2
                _wall_low__part_1 = translate([-_wall_low__part_1_x, -_wall_low__part_1_y, 0], _wall_low__part_1);
                _wall_low__part_1 = rotate([0,0,0], _wall_low__part_1);
                _wall_low__part_1 = translate([_wall_low__part_1_x, _wall_low__part_1_y, 0], _wall_low__part_1);

                _wall_low__part_1 = translate([0,0,0], _wall_low__part_1);
                result = result.subtract(_wall_low__part_1);
                ...
                function _outer_wall_low_case_fn() {
                    

                // creating part 0 of case _outer_wall_low
                let _outer_wall_low__part_0 = case_outline_extrude_5_6_outline_fn();

                // make sure that rotations are relative
                let _outer_wall_low__part_0_bounds = _outer_wall_low__part_0.getBounds();
                let _outer_wall_low__part_0_x = _outer_wall_low__part_0_bounds[0].x + (_outer_wall_low__part_0_bounds[1].x - _outer_wall_low__part_0_bounds[0].x) / 2
                let _outer_wall_low__part_0_y = _outer_wall_low__part_0_bounds[0].y + (_outer_wall_low__part_0_bounds[1].y - _outer_wall_low__part_0_bounds[0].y) / 2
                _outer_wall_low__part_0 = translate([-_outer_wall_low__part_0_x, -_outer_wall_low__part_0_y, 0], _outer_wall_low__part_0);
                _outer_wall_low__part_0 = rotate([0,0,0], _outer_wall_low__part_0);
                _outer_wall_low__part_0 = translate([_outer_wall_low__part_0_x, _outer_wall_low__part_0_y, 0], _outer_wall_low__part_0);

                _outer_wall_low__part_0 = translate([0,0,0], _outer_wall_low__part_0);
                let result = _outer_wall_low__part_0;
                ...
                function _inner_wall_low_case_fn() {
                    

                // creating part 0 of case _inner_wall_low
                let _inner_wall_low__part_0 = board_extrude_5_6_outline_fn();

                // make sure that rotations are relative
                let _inner_wall_low__part_0_bounds = _inner_wall_low__part_0.getBounds();
                let _inner_wall_low__part_0_x = _inner_wall_low__part_0_bounds[0].x + (_inner_wall_low__part_0_bounds[1].x - _inner_wall_low__part_0_bounds[0].x) / 2
                let _inner_wall_low__part_0_y = _inner_wall_low__part_0_bounds[0].y + (_inner_wall_low__part_0_bounds[1].y - _inner_wall_low__part_0_bounds[0].y) / 2
                _inner_wall_low__part_0 = translate([-_inner_wall_low__part_0_x, -_inner_wall_low__part_0_y, 0], _inner_wall_low__part_0);
                _inner_wall_low__part_0 = rotate([0,0,0], _inner_wall_low__part_0);
                _inner_wall_low__part_0 = translate([_inner_wall_low__part_0_x, _inner_wall_low__part_0_y, 0], _inner_wall_low__part_0);

                _inner_wall_low__part_0 = translate([0,0,0], _inner_wall_low__part_0);
                let result = _inner_wall_low__part_0;
                ...
                let case_lowpro__part_0 = _standoffs_case_fn();
