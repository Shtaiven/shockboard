...
module.exports = {
  params: {
    ...
    nice_nano_compat: { type: 'boolean', value: true },
    elite_c_compat: { type: 'boolean', value: true },
  ...
  body: p => {
    ...
    if (p.flipped) {
      pin_nets = [
        ...
        [`${p.RST.str}`, `${p.GND.str}`],
        [`${p.VCC.str}`, `${p.GND.str}`],
        [`${p.P031.str}`, `${p.P017.str}`],
        [`${p.P029.str}`, `${p.P020.str}`],
        [`${p.P002.str}`, `${p.P022.str}`],
        [`${p.P115.str}`, `${p.P024.str}`],
        [`${p.P113.str}`, `${p.P100.str}`],
        [`${p.P111.str}`, `${p.P011.str}`],
        [`${p.P010.str}`, `${p.P104.str}`],
        [`${p.P009.str}`, `${p.P106.str}`],
      ]
    } else {
      pin_nets = [
    ...
    */
    ...
    (fp_text user "nice_nano_elite_c" (at 0 -20 ${p.rot}) (layer F.SilkS)
    ...
    ${'' /*Lettering on the silkscreen*/}
    (fp_text user "nice_nano_elite_c" (at 0 -20 ${p.rot}) (layer B.SilkS)
...
${''}
${p.nice_nano_compat ? view_solder_pads : ''}

${''}
${p.elite_c_compat ? through_hole_bottom : ''}
`
